...
describe ('class test for product',()=>{
      let product;
...
describe ('class test for clothing',()=>{
      let product;
  ...
  beforeEach(() => {
    product = new Clothing({
      ...
      it('size chart link in extra info',()=>{
            expect(product.extraInfoHTML()).toContain(`<a href="images/clothing-size-chart.png" target="_blank">`);
      })
